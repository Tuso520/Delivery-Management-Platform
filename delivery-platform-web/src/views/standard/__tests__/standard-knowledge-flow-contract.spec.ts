...
describe('standard and knowledge target flows', () => {
  ...
  it('uses the dedicated Figma frames for both standard and knowledge libraries', () => {
    ...
    expect(knowledge).toContain('width: 90px')
    expect(knowledge).toContain('width: 130px')
    expect(knowledge).toContain('width: 170px')
    expect(knowledge).toContain('width: 182px')
