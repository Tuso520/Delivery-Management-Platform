...
describe('business component adoption contract', () => {
  ...
  it('keeps the project archive workspace aligned to the Figma 43:317 grid', () => {
    ...
    expect(archive).toContain("slotName: 'fileName', width: 340")
    expect(archive).toContain("slotName: 'version', width: 80")
    ...
    expect(archive).toContain("slotName: 'action', width: 182")
