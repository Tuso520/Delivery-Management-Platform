...
const labels = {
  ...
  stage: {
    ...
    '01_sale': ['售前与合同', 'Pre-sales & Contract'],
    '01_presale': ['售前与合同', 'Pre-sales & Contract'],
    '02_design': ['深化方案', 'Detailed Design'],
    '03_procurement': ['采购与生产', 'Procurement & Production'],
    '04_construction': ['施工与调试', 'Construction & Commissioning'],
    '05_acceptance': ['验收与移交', 'Acceptance & Handover'],
