...
5. 列表展示区域、状态、阶段、进度、签约/验收时间、原币金额、折算人民币、销售和项目经理。
...
页面同时加载：启用国家、币种、启用语言、`project_type` 字典，以及销售负责人、项目经理、项目成员三类目的化用户引用。

表单包含：

- 基础信息：名称、简称、国家、城市、客户、项目类型、语言。
...
入口：`/projects/:projectId` 和 `/projects/:projectId/edit`，分别打开详情或编辑抽屉。
