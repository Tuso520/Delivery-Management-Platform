...
6. 顶部“上传”默认选择当前目录中优先未上传的可上传档案项；“档案项”使用 Arco Select，候选项只来自所选项目绑定的版本化档案模板快照，因此切换项目或模板会同步改变目录与档案项。候选项按“目录 / 具体档案项”展示；档案项名称为通用“项目交付文件”或与目录同名时只显示目录，避免冗余。Arco Upload 仅负责选取文件并隐藏内置“开始/重试”动作，实际上传统一由弹窗底部“上传”提交。
