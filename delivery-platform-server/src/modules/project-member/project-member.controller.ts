...
export class ProjectMemberController {
  ...
  async findAll(@Param('projectId') projectId: string, @CurrentUser('sub') userId: string) {
    return this.projectMemberService.findByProject(projectId, userId);
  }

  @Post()
  @RequirePermissions({ all: ['project:manage_member'] })
  ...
  async updateRole(
    ...
    return this.projectMemberService.updateRole(projectId, memberId, dto, userId);
  }
