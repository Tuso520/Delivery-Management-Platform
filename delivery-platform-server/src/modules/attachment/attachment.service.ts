              ...
              <script type="module">
                ...
                async function renderPdf() {
                  ...
                  for (let pageNumber = 1; pageNumber <= maxPages; pageNumber += 1) {
                    ...
                    const viewport = page.getViewport({ scale: Math.min(window.devicePixelRatio || 1, 1.8) * 1.25 });
                    ...
                    canvas.style.width = Math.round(viewport.width / Math.min(window.devicePixelRatio || 1, 1.8)) + 'px';
                    canvas.style.height = Math.round(viewport.height / Math.min(window.devicePixelRatio || 1, 1.8)) + 'px';
...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .preview-table-block + .preview-table-block {
    ...
    @media (max-width: 960px) {
      .pdf-native-main { min-height: 520px; }
