...
main() {
  ...
  local required_keys=(
    ...
    INTEGRATION_SECRET_MIGRATION_ACTOR_USERNAME SEED_RESET_EXISTING_USER_PASSWORDS
  ...
  [ "$(env_value EXPECTED_MIGRATION_COUNT)" = '45' ] || \
    die 'EXPECTED_MIGRATION_COUNT must be 45'
